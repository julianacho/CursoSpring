...
//  Se marca como compnente de spring, el componente debe ser unico en la aplicacion
// .xlsx hace que la vista tome la version .xlsx que se basa de lo definido en el aplication.properties
...
public class FacturaXlsxView extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		// Permite indicar el nombre del excel
		response.setHeader("Content-Disposition", "attachment; filename=\"factura_view.xlsx\"");
		// Se obtiene el objeto factura
